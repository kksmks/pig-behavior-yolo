...
组装时间：2026-08-06 ｜ **更新至 v5：2026-08-07** ｜ **内容同步：2026-08-18** ｜ 稿件版本：v5（8 图 7 表 + 补充材料表 S1/S2）

> **当前状态：只差填作者信息**（作者/单位/通讯邮箱/ORCID、Funding、Author Contributions——填空模板见 paper/author-info-template.md）。
...
> 2026-08-18 同步：部署章延迟三段分解段 + 持续运行实测（12,000 次/10.7 min/零节流）、
> 功耗双口径（7 W 总输入 / 5 W 计算轨）、3.1 标注协议出处、讨论章告警路径；Cover Letter 同步双口径并补 S2 表述。
