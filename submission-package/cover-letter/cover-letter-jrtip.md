...
**Supplementary material.** One supplementary file (Supplementary_Material.pdf/docx) accompanies the submission, containing the per-class AP50 breakdown (validation set, Table S1; test set, Table S2) referenced in Section 4.4.
